 ...
 * ============================================================
 */
export async function createLoanApplication(userId, data) {
    /*
     * ----------------------------------------------------------
     * 1. Verify KYC
     * ----------------------------------------------------------
    ...
    const systemMaxAmount = await getNumericConfig("MAX_LOAN_AMOUNT", Number.MAX_SAFE_INTEGER);
    const systemMinDays = await getNumericConfig("MIN_REPAYMENT_DAYS", 1);
    const systemMaxDays = await getNumericConfig("MAX_REPAYMENT_DAYS", Number.MAX_SAFE_INTEGER);
    /*
     * ----------------------------------------------------------
     * 4. Validate amount
     * ----------------------------------------------------------
 ...
 * ============================================================
 */
export async function getCustomerLoanApplications(userId, query) {
 ...
 * ============================================================
 */
export async function getCustomerLoanApplication(userId, id) {
 ...
 * ============================================================
 */
export async function cancelLoanApplication(userId, id, data) {
 ...
 * ============================================================
 */
export async function getAdminLoanApplications(query) {
    const { page, limit, status, loanProductId, userId, search, sortBy, sortOrder, } = query;
    const where = {
        ...(status && {
            status,
        }),
 ...
 * ============================================================
 */
export async function getAdminLoanApplication(id) {
 ...
 * ============================================================
 */
export async function reviewLoanApplication(applicationId, reviewerId, data) {
    ...
    return prisma.$transaction(async (tx) => {
        ...
        const updated = await tx.loanApplication.update({
            ...
            data: {
                status: newStatus,
                reviewedAt: newStatus === "UNDER_REVIEW"
                    ? now
