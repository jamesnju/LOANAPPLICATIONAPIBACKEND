...
router.post("/", createKycController);
router.get("/", getMyKycController);
router.get("/:id", getKycByIdController);
router.patch("/", updateKycController);
router.post("/documents", addKycDocumentController);
router.delete("/documents/:id", deleteKycDocumentController);
