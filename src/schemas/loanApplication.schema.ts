...
export const createLoanApplicationSchema = z.object({
  ...
  requestedDays: z
    .number()
    .int(
      "Requested days must be a whole number",
    )
    .positive(
...
export type CreateLoanApplicationInput =
  z.infer<typeof createLoanApplicationSchema>;
...
export type LoanApplicationQueryInput =
  z.infer<typeof loanApplicationQuerySchema>;
...
export type CancelLoanApplicationInput =
  z.infer<typeof cancelLoanApplicationSchema>;
...
export const adminLoanApplicationQuerySchema =
  z.object({
    /*
     * Pagination.
     */
...
export type AdminLoanApplicationQueryInput =
  z.infer<
    typeof adminLoanApplicationQuerySchema
  >;
...
export const reviewLoanApplicationSchema =
  z
    .object({
      /*
    ...
    .superRefine((data, ctx) => {
      ...
      if (
        ...
        ctx.addIssue({
          ...
          path: ["comments"],
          message:
            "Comments are required when requesting documents",
        });
      }
    });

export type ReviewLoanApplicationInput =
  z.infer<
    typeof reviewLoanApplicationSchema
  >;