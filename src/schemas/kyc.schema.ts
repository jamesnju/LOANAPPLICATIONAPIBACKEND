...
export type CreateKycDocumentInput =
  z.infer<typeof createKycDocumentSchema>;
  ...
  .superRefine((data, ctx) => {
    if (
      ...
      ctx.addIssue({
        ...
        path: ["reviewNotes"],
        message:
          "Review notes are required when rejecting KYC",
      });
    }
  });

export type ReviewKycInput =
  z.infer<typeof reviewKycSchema>;
...
export type AdminKycQueryInput =
  z.infer<typeof adminKycQuerySchema>;
