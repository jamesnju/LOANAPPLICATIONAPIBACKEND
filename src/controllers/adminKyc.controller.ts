 ...
 */
export async function getAdminKycController(
  req: Request,
  res: Response,
) {
  try {
    const query =
      adminKycQuerySchema.parse(
        req.query,
      );

    const result =
      await getKycList(query);
 ...
 */
export async function getAdminKycByIdController(
  req: Request,
  res: Response,
) {
  try {
 ...
 */
export async function reviewKycController(
  req: Request,
  res: Response,
) {
  try {
